...
\section{Objetivos}
O objetivo principal desse experimento foi a comparação do valor esperado obtido pelo modelo teórico de uma distribuição binomial com os dados obtidos com sucessivos ensaios de Bernoulli

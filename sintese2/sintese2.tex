...
suporte por um fio de comprimento $35,0\pm0,1 cm$, 100 com um cronômetro de mão e 100 com um cronômetro de mesa, 20 por
integrante com ambos os instrumentos.

\section{RESULTADOS}
A Tabela \ref{tab:medições_cm} contém as medidas do período de $10$ oscilações
do pêndulo

...
Foram realizadas 200 medições do período de $10$ oscilações de um pêndulo simples composto por uma massa esférica presa a um
suporte por um fio de comprimento $35,00\pm0,05$ $cm$, 100 com um cronômetro de mão e 100 com um cronômetro de mesa, 20 por
...
A Tabela \ref{tab:final}
contém os valores e incertezas finais dos períodos medidos utilizando cronômetro de mão ($T^{(1)}$) e de bancada ($T^{(2)}$), as
estimativas experimentais da aceleração da gravidade local associadas ($g^{(1)}$ e $g^{(2)}$, respectivamente), e o valor de
referência da aceleração local da gravidade $g_{0}$
\begin{table}[H]
	\centering
	\caption{Valores e incertezas finais dos períodos medidos utilizando cronômetro de mão ($T^{(1)}$) e de bancada ($T^{(2)}$), as
		estimativas experimentais da aceleração da gravidade local associadas ($g^{(1)}$ e $g^{(2)}$, respectivamente), e o valor de
		referência da aceleração local da gravidade $g_{0}$}
	\begin{tabular}{l l l}
		\hline
		...
		$g^{(1)}\ \mathrm{(m/s^{2})}$ & $10,025$ & 0,148     \\
		$g^{(2)}\ \mathrm{(m/s^{2})}$ & $10,059$ & 0,148     \\
